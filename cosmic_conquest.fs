...
: hposn drop drop ; : hline drop drop ;
: h1 ; : hclr ; : draw drop ; : scale drop ; : hcolour drop ;
...
0 VARIABLE C-LEGIONS    ( no. of computer legions )        -->
...
: DRAW-BORDERS   ( draw borders of display and headings)
   CLEAR-SCREEN
...
: LEAVELEGION   ( leave legions from fleet as garrison)
...
: FRIENDLY-PLANET   ( options upon landing at colony)
   BEGIN
      ...
      CLEAR-MSGE
      CASE
         49 ( 1) OF LEAVELEGION 0   ( leave legions) ENDOF -->
